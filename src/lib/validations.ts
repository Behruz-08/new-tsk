 ...
 * Улучшенная система валидации с централизованными константами
 */
...
const fileSchema = z
  ...
  .refine(
    (file) =>
      (FILE_CONFIG.ALLOWED_TYPES as readonly string[]).includes(file.type),
...
export const contactFormSchema = z.object({
  name: z
    ...
    .regex(
      VALIDATION_PATTERNS.LETTERS_ONLY,
